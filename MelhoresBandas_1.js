function biografia(){
    ...
    if(integrantes == "Selecione um integrante"){
        ...
        document.getElementById("integrantes").innerHTML = '<div>Roger Taylor é um músico, compositor, multi-instrumentista, cantor e backing vocal britânico. Foi baterista, backing-vocal e membro fundador da banda Queen. É considerado um dos melhores e mais influentes bateristas de rock da década de 1970 e 80. Como compositor, Taylor contribuiu com músicas de álbuns da banda, desde o começando a compor pelo menos uma faixa em cada álbum, geralmente cantou os vocais em suas próprias composições.</div>';
        ...
        document.getElementById("integrantes").innerHTML =  '<div>John Deacon é um músico britânico aposentado, mais conhecido por ter sido o baixista e um dos compositores da banda de rock Queen. Foi o último dos quatro membros a entrar para o grupo em 1971 e também o mais jovem, tendo apenas 19 anos quando foi efetivado.</div>';
...
function biografia1(){
    ...
    document.getElementById("integrantes2").innerHTML = '<div>Jimmy Page é um músico, produtor musical e compositor britânico que alcançou sucesso internacional como guitarrista da banda de rock Led Zeppelin. Começou sua carreira como músico de estúdio em Londres e, em meados da década de 1960, tornou-se o guitarrista de sessão mais procurado na Inglaterra. Foi membro dos Yardbirds de 1966 até 1968, e posteriormente fundou o Led Zeppelin, em 1968.</div>';
    ...
    document.getElementById("integrantes2").innerHTML = '<div>John Bonham foi um músico e compositor inglês, mais conhecido por ter sido o baterista da banda Led Zeppelin. Bonham era admirado por sua velocidade, potência, sons característicos, e sensibilidade para o groove. É amplamente considerado um dos melhores bateristas da história do rock. Em 2011 os leitores da Rolling Stone consideraram Bonham o "melhor baterista de todos os tempos".</div>';
...
function biografia2(){
    ...
    document.getElementById("integrantes3").innerHTML = '<div>Bill Ward é um baterista inglês, sendo o primeiro baterista e um dos fundadores da banda britânica de heavy metal Black Sabbath. Ficou em 8° lugar na lista dos "50 melhores bateristas de hard rock e metal de todos os tempos" do site Loudwire. Em lista da revista Rolling Stone, Ward ficou na posição 42 dos "100 Maiores Bateristas de Todos os Tempos.</div>';
    ...
    document.getElementById("integrantes3").innerHTML = '<div>Geezer Butler é um baixista e compositor inglês. O músico é conhecido por ter tocado na banda de heavy metal Black Sabbath, pioneira do gênero, onde Butler escrevia todas as letras durante os anos 1970, e é tido como um dos mais influentes de todos os tempos com seu instrumento. Geezer foi conhecido como um dos primeiros baixistas a usar pedal wah-wah no seu baixo, que usou no início de "N.I.B." Geezer também foi um dos primeiros baixistas a usar uma afinação um tom abaixo no caso, D (Ré), após isso, Iommi passou a afinar sua guitarra em C#. A afinação em D é muito comum em bandas de Heavy Metal.</div>';
...
function biografia3(){
    ...
    document.getElementById("integrantes4").innerHTML = '<div>Angus Young é um guitarrista e compositor escocês naturalizado na Austrália, conhecido por ser guitarrista solo, compositor, líder e co-fundador da banda de hard rock australiana AC/DC. No ano de 2003, foi introduzido juntamente de Malcolm Young, Brian Johnson e outros membros do AC/DC no Rock and Roll Hall of Fame. Foi considerado o 24.º melhor guitarrista de todos os tempos pela revista norte-americana Rolling Stone.</div>';
    ...
    document.getElementById("integrantes4").innerHTML = '<div>Stevie Young é um guitarrista escocês da banda de hard rock AC/DC, tendo entrado no lugar do seu tio Malcolm Young, que deixou o grupo por problemas de saúde. Ele é também sobrinho do outro guitarrista da banda, Angus Young; do produtor George Young, que já trabalhou com o grupo; e do músico Alexander Young, morto em 1997. Seu pai é Stephen Young, o mais velho dos irmãos.</div>';
    ...
    document.getElementById("integrantes4").innerHTML = '<div>Brian Johnson é um cantor e compositor britânico. Desde 1980 ele é o vocalista da banda de hard rock australiana AC/DC. Em 2016, foi afastado da banda por problemas auditivos, retornando em 2018. O primeiro álbum de Brian com o AC/DC foi Back in Black. Em 1997, Brian gravou com a banda Jackyl a música "Locked and Loaded", e em 2002 escreveu a música "Kill The Sunshine" do álbum Relentless.</div>';
...
function biografia4(){
    ...
    document.getElementById("integrantes5").innerHTML = '<div> Duff McKagan é um músico estadunidense. Ele é mais conhecido por ser membro fundador e baixista por quase 30 anos da banda de hard rock Guns N Roses, com quem alcançou sucesso mundial no final de 1980 e início de 1990 e também que deixou no auge de sua fama em 1997.</div>';
    ...
    document.getElementById("integrantes5").innerHTML = '<div> Dizzy Reed é um multi-instrumentista norte-americano. Ele é o tecladista que atua na banda Guns N Roses desde 1990. Começou a sua carreira no show da banda Guns N Roses no Brasil no grande festival Rock in Rio de 1991.</div>';
    ...
    document.getElementById("integrantes5").innerHTML = '<div>Melissa Reese é uma cantora e compositora norte-americana. Alguns de seus inúmeros trabalhos incluem projetos com o músico Bryan "Brain" Mantia. Atualmente, ela integra a banda de hard rock Guns N Roses.</div>';
...
function biografia5(){
    ...
    document.getElementById("integrantes6").innerHTML = '<div>Lars Ulrich é um músico, ator, empresário, produtor musical, radialista e ex-tenista dinamarquês. Alcançou fama mundial por ser o baterista e o co-fundador (juntamente com James Hetfield) da banda norte-americana de heavy metal, Metallica. Ele é filho do ex-tenista profissional Torben Ulrich, neto do também ex-tenista Einer Ulrich, e foi afilhado do músico de jazz Dexter Gordon. Em 2004, a revista Kerrang! elegeu Lars a 9ª personalidade de maior influência no mundo do rock n roll. Ficou em 55° lugar na lista dos "66 melhores bateristas de hard rock e metal de todos os tempos" do site Loudwire.</div>';
...
function biografia6(){
    ...
    document.getElementById("integrantes7").innerHTML = '<div>Nicko McBrain é um músico inglês de heavy metal. É conhecido por ser o baterista da banda Iron Maiden, onde ingressou em dezembro de 1982 e permanece desde então gravando todos os discos. Anteriormente foi baterista de bandas como Trust, Streetwalkers e Pat Travers.</div>';
